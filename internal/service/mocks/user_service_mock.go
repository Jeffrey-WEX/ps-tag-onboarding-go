...
func (_m *IUserService) CreateUser(newUser *model.User) (*model.User, *errormessage.ErrorMessage) {
...
func (_m *IUserService) GetUserById(userId string) (*model.User, *errormessage.ErrorMessage) {
